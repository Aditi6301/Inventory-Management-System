...
<div class="row">
           ...
           <div class="col-xl-12 col-md-6 mb-4">
                   ...
                   <form method="post" autocomplete="on">
                    ...
                    <div class="form-group col-xl-3">
                     <select class="form-control custom-select" name="products" id="products" name="type" data-toggle="tooltip" data-placement="top" title="Product" onchange="getCategory(this.value);" required></select>
                    </div>
                     <div class="form-group col-xl-3">
                     <select class="form-control custom-select" name="categories" id="categories" name="type" data-toggle="tooltip" data-placement="top" title="Category" placeholder="Select Category" required></select>
                    </div>
          </div>
  ...
  <input name="length" type="text" class="form-control" id="length" placeholder="Length" required>
  </div>
  <div class="form-group col-xl-2 col-md-6 mb-4">
    <input name="width" type="text" name="width" class="form-control" id="width" placeholder="Width" required>
  </div>
  <div class="form-group col-xl-2 col-md-6 mb-4">
    <input name="pieces" type="text" class="form-control" id="pieces" placeholder="No of pieces" required>
  </div>
  <div class="form-group col-xl-2 col-md-6 mb-4">
